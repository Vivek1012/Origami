...
(function () {
        ...
        _searchData: function (queryText) {
            ...
            if (window.Data) {
                originalResults = Data.items.createFiltered(function (item) {
                    return (item.title.indexOf(queryText) >= 0 || item.content.indexOf(queryText) >= 0 || item.description.indexOf(queryText) >= 0);
    ...
    appModel.Search.SearchPane.getForCurrentView().onsuggestionsrequested = function (eventObject) {
	    ...
	    var terms = [ "boat", "fold", "bird", "traditional", "star", "cat", "fish"];
